...
window.onload = function() {
  ...
  const now = Date.now()
  let futureProblems = problemStarts.filter((a) => { return a.start < now})
  console.log(futureProblems[0].index, new Date(futureProblems[0].start))
  selectProblem(futureProblems[0].index)
}